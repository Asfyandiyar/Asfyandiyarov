...
public class AStarPathfinder
{
    ...
    //осуществляется вычисление пути от начального положения до пункта назначения
    ...
    //метод принимает путевую точку и генерирует подходящие следующие шаги
    ...
    //вычисление расстояния между двумя указанными местоположениями
